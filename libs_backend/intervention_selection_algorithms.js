(function(){
  ...
  ref$ = require('libs_backend/db_utils'), getkey_dictdict = ref$.getkey_dictdict, setkey_dictdict = ref$.setkey_dictdict, getvar_experiment = ref$.getvar_experiment;
